...
import styles from "./GameIDStyles";
...
export default class GameID extends React.Component {
  ...
  storeID = (validID) => {
    ...
    validID
      ? (SecureStore.setItemAsync("gameID", this.state.gameID),
        ...
        callback(this.state.gameID, this.state.accountID, this.state.platform))
  ...
  render() {
    const { callback } = this.props.route.params;
    return this.state.gameIDLoaded ? (
      this.state.gameID ? (
        <UserInfo
        ...
        <View style={styles.container}>
          ...
          <View style={styles.inputContainer}>
            <View style={{ flexDirection: "row" }}>
              <TouchableOpacity onPress={this.selectSteam}>
                <SteamIcon
                  style={[
                    styles.icon,
              ...
              <TouchableOpacity onPress={this.selectXbox}>
                <XboxIcon
                  style={[
                    styles.icon,
                    styles.xboxIcon,
              ...
              <TouchableOpacity onPress={this.selectPlaystation}>
                <PlaystationIcon
                  style={[
                    styles.icon,
                    this.playstationSelected()
                      ? styles.selectedPlaystation
                      : null,
                  ]}
                />
              </TouchableOpacity>
